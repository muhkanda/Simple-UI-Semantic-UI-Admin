# DataTables for jQuery with styling for [Semantic UI](http://semantic-ui.com/)

This package contains distribution files required to style [DataTables library](https://datatables.net) for [jQuery](http://jquery.com/) with styling for [Semantic UI](http://semantic-ui.com/).
