...
b.modal=function(a){return function(b,e,f){c.fn.modal?e||(a&&a.header&&d.find("div.header").empty().append('<h4 class="title">'+a.header(b)+"</h4>"),d.find("div.content").empty().append(f()),d.parent().hasClass("dimmer")||d.appendTo("body"),d.modal("show")):g(b,e,f)}};return a.Responsive});
